...
AppGenerator.prototype.writeIndex = function writeIndex() {
  ...
  if (!this.includeRequireJS) {
    this.indexFile = this.appendScripts(this.indexFile, 'scripts/main.js', [
      ...
      'bower_components/btapp/plugin.btapp.js',
      'bower_components/btapp/pairing.btapp.js',
      'bower_components/btapp/client.btapp.js',
      'bower_components/btapp/btapp.js',
      'scripts/main.js'
    ]);
...
AppGenerator.prototype.requirejs = function requirejs() {
  if (this.includeRequireJS) {
    ...
    this.mainJsFile = [
      ...
      '        \'btapp-plugin\': \'../bower_components/btapp/plugin.btapp\',',
      '        \'btapp-pairing\': \'../bower_components/btapp/pairing.btapp\',',
      '        \'btapp-client\': \'../bower_components/btapp/client.btapp\',',
      '        \'btapp\': \'../bower_components/btapp/btapp\',',
      ...
      '        },',
      '        \'btapp-plugin\': {',
      '            deps: [\'backbone\', \'underscore\', \'jstorage\'],',
      '            exports: \'Btapp\'',
      '        },',
      '        \'btapp-pairing\': {',
      '            deps: [\'backbone\', \'underscore\', \'jstorage\'],',
      ...
      '        },',
      '        \'btapp-client\': {',
      '            deps: [\'backbone\', \'underscore\', \'jstorage\', \'btapp-plugin\', \'btapp-pairing\'],',
      '            exports: \'Btapp\'',
      '        },',
      '        \'btapp\': {',
      '            deps: [\'backbone\', \'underscore\', \'jstorage\', \'btapp-client\'],',
      '            exports: \'Btapp\'',
      '        }',
      '    }',
      '});',
      '',
      'require([\'jquery\', \'btapp\'], function ($, Btapp) {',
      '    \'use strict\';',
      '    var btapp = new Btapp();',
      '    btapp.on(\'all\', console.log, console);',
      '    btapp.connect();',
